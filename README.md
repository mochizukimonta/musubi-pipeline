...
ギガファイル便のリンクを貼らなくていい。<br>
`c01_final_final2.blend` を作らなくていい。<br>
「最新どれ?」と聞かなくていい。
...
| アセットの進み具合を1つずつ開いて確かめる | 一覧に更新・担当・コメント・作業中が並ぶ(開かずに読める) |
| 「今日どのカットから?」を毎朝聞く | カット一覧がリテイク・作業中の順に並ぶ(自分の担当だけに絞れる) |
...
4. **「ルート」にプロジェクト用のフォルダを指定します**

**4番目がこのアドオンの入口です。** ルートを指定すると、履歴もロックも
進行ボードも同期も、そこを起点に動き出します。指定するまでは
「プロジェクト」だけが表示されます。次に開くときは一覧から選べます。
